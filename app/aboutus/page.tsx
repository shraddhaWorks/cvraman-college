...
export default function AboutPage() {
  return (
    <div className="w-full">
      ...
      {/* About Content */}
      <section className="bg-primary/[0.08] dark:bg-foreground">
          ...
          <div className="relative border border-slate-200 bg-white dark:border-white/10 rounded-[2.5rem] overflow-hidden bg-slate-50/30 dark:bg-background/[0.02] p-8 md:p-16 transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-7">
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-8 leading-tight font-heading">
                  Our <span className="text-primary">Mission</span>
                </h2>

                <div className="space-y-6">
                  <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl leading-relaxed font-light font-sans">
              ...
              <div className="lg:col-span-5">
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-secondary/20 dark:bg-secondary/10 blur-3xl rounded-full scale-75 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />

                  <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-3xl p-10 shadow-xl shadow-slate-200/50 dark:shadow-none flex flex-col items-center text-center transition-all duration-300">
                    ...
                    <div className="w-full h-1 bg-slate-100 dark:bg-white/5 mt-8 rounded-full overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center mb-16">
      <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4 font-heading tracking-tight">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      {/* Team Section */}
     <section className="py-15 bg-primary/[0.08] dark:bg-foreground">
        <div className="max-w-7xl  dark:bg-transparent mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4 font-heading tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              <div key={i} className="group relative overflow-hidden rounded-[2rem] border border-slate-200 dark:border-white/10 bg-slate-50/50 bg-white/60 dark:bg-white/[0.05] p-8 text-center transition-all duration-500 hover:-translate-y-2">
                <div className="relative w-20 h-20 mx-auto mb-6">
                  <div className="absolute inset-0 bg-secondary/20 rounded-2xl rotate-6 group-hover:rotate-12 transition-transform" />
                  <div className="relative w-full h-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-2xl flex items-center justify-center text-xl font-bold text-secondary font-heading">
                    {member.initial}
                  </div>
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-1 font-heading">{member.name}</h3>
