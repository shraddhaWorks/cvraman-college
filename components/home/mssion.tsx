  ...
  },
  {
    ...
    icon: (
      <div className="relative">
        ...
        <Ban className="absolute -top-1 -right-1 text-red-600 opacity-40 dark:opacity-60" size={24} />
      </div>
    ),
...
export default function Mission() {
  return (
    ...
    <section className="py-16 md:py-24 bg-primary/[0.08] dark:bg-black px-6 md:px-12 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {policies.map((item, index) => (
            <motion.div
              ...
              className="group relative bg-white dark:bg-zinc-900 rounded-2xl shadow-lg dark:shadow-none overflow-hidden flex flex-col items-center text-center border border-transparent hover:border-primary/30 dark:hover:border-primary/50 transition-all duration-300"
            >
              ...
              <div className="py-12 flex justify-center items-center group-hover:scale-110 transition-transform duration-500">
                <div className="p-4 rounded-full bg-primary/5 dark:bg-primary/10 transition-colors">
                  {item.icon}
                </div>
              </div>
              ...
              <div className="px-10 pb-12">
                <p className="text-foreground/70 dark:text-background/60 font-sans leading-relaxed text-sm md:text-base">
                  {item.content}
                </p>
              </div>
